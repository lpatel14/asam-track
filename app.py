...
def main():
    ...
    fig1.update_layout(title='Portfolio Value', xaxis_title='Date', yaxis_title='Value ($)', width=1200, height=800, bordercolor='rgb(0,0,0)', borderwidth=2, margin=dict(l=10, r=10, t=40, b=40))
    ...
    fig2.update_layout(title='Simple Return', xaxis_title='Date', yaxis_title='Return (%)', width=1200, height=800, bordercolor='rgb(0,0,0)', borderwidth=2, margin=dict(l=10, r=10, t=40, b=40))
