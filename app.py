...
def main():
    ...
    analysis_end_date_plusone = pd.to_datetime(most_recent_trading_day + pd.Timedelta(days=1), format='%Y-%m-%d') #just add one to the above mentioned date, need not be a working day
